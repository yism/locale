...
- [Compare and Decide](./compare-and-decide.md)

## Hardening truth

- [Verification Workflow](./verification-workflow.md)
- [Adversarial Self-Improvement](./adversarial-self-improvement.md)
- [Adoption Checklist](./adoption-checklist.md)
- [Changelog](./changelog.md)
- [Change Pipeline](./change-pipeline.md)
- [Protocol Foundations](./protocol-foundations.md)
- [Conformance Spec](./conformance-spec-v0.1.md)
